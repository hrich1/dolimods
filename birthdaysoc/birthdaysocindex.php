...
/**
 *	\file       birthdaysoc/birthdaysocindex.php
 *	\ingroup    birthdaysoc
 *	\brief      Home page of birthdaysoc top menu
 */
...
$langs->loadLangs(array("birthdaysoc@birthdaysoc"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->birthdaysoc->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("BirthdaySocArea"));

print load_fiche_titre($langs->trans("BirthdaySocArea"), '', 'birthdaysoc.png@birthdaysoc');
...
// Draft MyObject
if (! empty($conf->birthdaysoc->enabled) && $user->rights->birthdaysoc->read)
{
	$langs->load("orders");
