...
/**
 *  \file       birthdaysoc/core/modules/birthdaysoc/doc/pdf_standard.modules.php
 *  \ingroup    birthdaysoc
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->birthdaysoc->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->birthdaysoc->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->birthdaysoc->dir_output.'/myobject/'.$objectref;
