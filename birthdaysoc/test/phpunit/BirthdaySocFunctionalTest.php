...
/**
 * \file    test/phpunit/BirthdaySocFunctionalTest.php
 * \ingroup birthdaysoc
...
/**
 * Class BirthdaySocFunctionalTest
 *
 ...
 *
 * @package Testbirthdaysoc
 */
class BirthdaySocFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBirthdaySoc')->click();
		} else {
			// Disable the module
			$this->byHref('modBirthdaySoc')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/birthdaysoc/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('birthdaysoc/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/birthdaysoc/admin/about.php');
		$this->authenticate();
		return $this->assertContains('birthdaysoc/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('birthdaysocwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBirthdaySoc_BirthdaySocTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBirthdaySoc_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
