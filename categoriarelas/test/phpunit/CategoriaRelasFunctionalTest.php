...
/**
 * \file    test/phpunit/CategoriaRelasFunctionalTest.php
...
/**
 * Class CategoriaRelasFunctionalTest
 *
 ...
 *
 * @package Testcategoriarelas
 */
class CategoriaRelasFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCategoriaRelas')->click();
		} else {
			// Disable the module
			$this->byHref('modCategoriaRelas')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/categoriarelas/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('categoriarelas/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/categoriarelas/admin/about.php');
		$this->authenticate();
		return $this->assertContains('categoriarelas/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('categoriarelaswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCategoriaRelas_CategoriaRelasTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCategoriaRelas_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
