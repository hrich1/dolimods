...
/**
 *  \file       muprof_contact.php
 *  \ingroup    multiprodof
 *  \brief      Tab for contacts linked to MuPrOf
 */
...
$hookmanager->initHooks(array('muprofcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('MuPrOf')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id)
{
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("MuPrOf"), -1, $object->picto);
