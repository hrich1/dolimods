...
/**
 * \file    test/phpunit/MultiProdOfFunctionalTest.php
 * \ingroup multiprodof
...
/**
 * Class MultiProdOfFunctionalTest
 *
 ...
 *
 * @package Testmultiprodof
 */
class MultiProdOfFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMultiProdOf')->click();
		} else {
			// Disable the module
			$this->byHref('modMultiProdOf')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/multiprodof/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('multiprodof/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/multiprodof/admin/about.php');
		$this->authenticate();
		return $this->assertContains('multiprodof/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('multiprodofwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMultiProdOf_MultiProdOfTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMultiProdOf_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
