		...
		if ($conf->facture->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				for ($i = 0; $i < $nblines; $i++)
				{
					...
					SetTwoDecimals(2);
					// Total HT line
					$total_excl_tax = 		getlinetotalexcltax_mod($object, $i, $outputlangs, $hidedetails);
 ...
 */
function getlinetotalexcltax_mod($object, $i, $outputlangs, $hidedetails = 0)
{
